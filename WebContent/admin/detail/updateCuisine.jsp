...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/admin/detail/style/images/title_arrow.gif"/>  更新菜系
		</div>
    </div>
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath}/updateFoodType" method="post">
		<!-- 本段标题（分段标题） -->
		<div class="ItemBlock_Title">
        	<img width="4" height="7" border="0" src="${pageContext.request.contextPath}/admin/detail/style/images/item_point.gif"> 菜系信息&nbsp;
        </div>
		<!-- 本段表单字段 -->
				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								<input type="text" name="foodTypeExtend.typename" class="InputStyle" value="${FoodTypeExtend.typename }"/> ${success }
								<input type="hidden" name="id" value="${FoodTypeExtend.id }" />
							</td>
						</tr>
					</table>
				</div>
