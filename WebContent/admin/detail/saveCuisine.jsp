...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/admin/detail/style/images/title_arrow.gif"/>  添加菜系
		</div>
    </div>
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath}/insertFoodType" method="post">
		<!-- 本段标题（分段标题） -->
				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								<input type="text" name="FoodTypeExtend.typename" class="InputStyle" value=""/> ${success }
