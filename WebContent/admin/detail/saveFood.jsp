...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
			<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/admin/detail/style/images/title_arrow.gif"/> 添加新菜品
		</div>
    </div>
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath}/insertFood" method="post" enctype="multipart/form-data" ><!-- enctype="multipart/form-data" -->
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
						...
						<tr>
							<td width="80px">菜名</td>
							<td><input type="text" name="foodExtend.foodname" class="InputStyle" value=""/> *</td>
						</tr>
						<tr>
							<td>价格</td>
							<td><input type="text" name="foodExtend.price" class="InputStyle" value=""/> *</td>
						</tr>
                        <tr>
							<td>会员价格</td>
							<td><input type="text" name="foodExtend.mprice" class="InputStyle" value=""/> *</td>
						</tr>
						
						<tr>
							<td>简介</td>
							<td><textarea name="foodExtend.remark" class="TextareaStyle"></textarea></td>
						</tr>
						<tr>
